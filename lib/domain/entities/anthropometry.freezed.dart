...
/// Adds pattern-matching-related methods to [Anthropometry].
extension AnthropometryPatterns on Anthropometry {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Anthropometry value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Anthropometry() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(double imt, String result)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Anthropometry() when $default != null:
        return $default(_that.imt, _that.result);
      case _:
        return orElse();
    }
  }

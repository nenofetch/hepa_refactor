...
class _$NutrientImpl implements _Nutrient {
  const _$NutrientImpl({required this.day, required this.total});
  ...
  @override
  String toString() {
    return 'Nutrient(day: $day, total: $total)';
  }
...
abstract class _Nutrient implements Nutrient {
  const factory _Nutrient(
      {required final String day, required final int total}) = _$NutrientImpl;

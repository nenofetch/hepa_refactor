...
extension SportPatterns on Sport {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Sport value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            ...
            @JsonKey(name: 'five_minute_calories') String fiveMinutesCalories,
            @JsonKey(name: 'fifteen_minute_calories')
            String fifteenMinuteCalories,
            @JsonKey(name: 'thirty_minute_calories')
            String thirtyMinutesCalories,
            @JsonKey(name: 'one_hour_calories') String oneHourCalories)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _Sport() when $default != null:
        return $default(
            _that.id,
            _that.name,
            _that.fiveMinutesCalories,
            _that.fifteenMinuteCalories,
            _that.thirtyMinutesCalories,
            _that.oneHourCalories);
      case _:
        return orElse();
    }
  }
